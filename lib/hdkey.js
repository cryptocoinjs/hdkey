...
Object.defineProperty(HDKey.prototype, 'privateExtendedKey', {
  get: function () {
    if (this._privateKey) return cs.encode(this.privateExtendedKeyBuffer)
    else return null
  }
})

Object.defineProperty(HDKey.prototype, 'privateExtendedKeyBuffer', {
  get: function () {
    if (this._privateKey) return serialize(this, this.versions.private, Buffer.concat([new Buffer([0]), this.privateKey]))
    else return null
  }
})
...
Object.defineProperty(HDKey.prototype, 'publicExtendedKey', {
  get: function () {
    return cs.encode(this.publicExtendedKeyBuffer)
  }
})

Object.defineProperty(HDKey.prototype, 'publicExtendedKeyBuffer', {
  get: function () {
...
HDKey.fromExtendedKeyBuffer = function (keyBuffer, versions) {
...
HDKey.fromExtendedKey = function (base58key, versions) {
  return HDKey.fromExtendedKeyBuffer(cs.decode(base58key), versions)
}
